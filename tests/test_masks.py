...
@pytest.mark.parametrize(
    "card_num, expected", [("1234567890123456", "1234 56** **** 3456"), ("5555444433332222", "5555 44** **** 2222")]
)
def test_get_mask_card_number_valid(card_num, expected):
    assert get_mask_card_number(card_num) == expected


@pytest.mark.parametrize("account_num, expected", [("123456789012", "**9012"), ("987654321098", "**1098")])
